...
bool PopupAvatar::init()
{
	...
	level->setPosition(Vec2(origin.x + label->getContentSize().width*1.2,
		origin.y + visibleSize.height - level->getContentSize().height * 4.2));
	level->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	level1->setPosition(Vec2(origin.x + label->getContentSize().width * 2.4,
		origin.y + visibleSize.height - level->getContentSize().height * 4.2));
	level1->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	Id->setPosition(Vec2(origin.x + label->getContentSize().width * 1.2,
		origin.y + visibleSize.height - level->getContentSize().height * 5.4));
	Id->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	Id1->setPosition(Vec2(origin.x + label->getContentSize().width * 1.8,
		origin.y + visibleSize.height - level->getContentSize().height * 5.4));
	Id1->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	vip->setPosition(Vec2(origin.x + label->getContentSize().width*1.2,
		origin.y + visibleSize.height - level->getContentSize().height * 6.6));
	vip->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	vip1->setPosition(Vec2(origin.x + label->getContentSize().width * 2,
		origin.y + visibleSize.height - level->getContentSize().height * 6.6));
	vip1->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	soDT->setPosition(Vec2(origin.x + label->getContentSize().width*1.2,
		origin.y + visibleSize.height - level->getContentSize().height * 7.8));
	soDT->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	soDT1->setPosition(Vec2(origin.x + label->getContentSize().width * 2,
		origin.y + visibleSize.height - level->getContentSize().height * 7.8));
	soDT1->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	sovanchoi->setPosition(Vec2(origin.x + sovanchoi->getContentSize().width * 1.2,
		origin.y + visibleSize.height / 2 - sovanchoi->getContentSize().height * 3.8));
	...
	sovanchoi1->setPosition(Vec2(origin.x + sovanchoi->getContentSize().width * 1.2,
		origin.y + visibleSize.height / 2 - sovanchoi->getContentSize().height * 5.3));
	...
	avatar->setPosition(Vec2(origin.x + visibleSize.width / 2,
		origin.y + visibleSize.height - avatar->getContentSize().height*1.4 ));
	...
	chisoTN->setPosition(Vec2(origin.x + visibleSize.width - chisoTN->getContentSize().width*1.5,
		origin.y + visibleSize.height - label->getContentSize().height * 3));
	chisoTN->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	chisoTN1->setPosition(Vec2(origin.x + visibleSize.width - chisoTN->getContentSize().width/2,
		origin.y + visibleSize.height - label->getContentSize().height * 3));
	chisoTN1->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	tienken->setPosition(Vec2(origin.x + visibleSize.width - chisoTN->getContentSize().width*1.5,
		origin.y + visibleSize.height - level->getContentSize().height * 4.4));
	tienken->setScale(1.2f);
	tienken->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	tienxu->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
	...
	ken->setPosition(Vec2(origin.x + visibleSize.width - chisoTN->getContentSize().width*1.3,
		origin.y + visibleSize.height - level->getContentSize().height * 4.4));
	ken->setScale(1.2f);
	ken->setAnchorPoint(Vec2::ANCHOR_TOP_LEFT);
